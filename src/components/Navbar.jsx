...
const Navbar = () => {
  ...
  return (
    <nav className="w-full bg-black min-h-[60px]"> {/* Adjust the min-height as needed */}
      <div className="flex justify-between items-center w-full md:px-2 px-3 py-2"> {/* Reduced padding */}
        <Link to="/">
          <img src="/logo.png" alt="Logo" className="w-[175px] h-[52px] ml-10 md:ml-2 lg:ml-36" />
        </Link>
