    ...
    <div className="flex flex-col md:flex-row bg-[#E4E4E7] h-screen">
      ...
      <div className="w-full md:w-1/2 p-6 md:p-10 overflow-y-auto">
        ...
        <p className="text-start text-black text-base md:text-[16px] font-lg mt-4 ml-4 md:ml-16">
          99Product Solutions is a dynamic IT service provider, specializing in
          ...
          <br />
          <br />
          At 99product Solutions, we pride ourselves on our customer-centric
      ...
      <div className="hidden relative md:flex justify-center items-center w-full md:w-1/2 ">
        ...
        <div className="relative flex justify-center items-end w-full h-full ">
          {/* Circular pattern */}
          <div className="absolute left-[550px] bottom-[150px] lg:left-[520px] md:left-[420px] md:bottom-[300px] lg:bottom-[120px] transform rotate-180 ">
        ...
        <div className="flex space-x-4 md:space-x-8">
          <div className="absolute top-28 md:top-[420px] left-4 md:left-6 w-[200px] lg:top-[160px] lg:left-[60px] h-[200px] md:w-[230px] md:h-[230px] bg-white bg-opacity-30 backdrop-blur-lg rounded-xl"></div>
