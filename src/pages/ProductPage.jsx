...
const ProductPage = () => {
  ...
  <img src="/mobile.png" alt="" className="relative z-10  w-full h-full object-cover lg:mr-32" />
      ...
      <div className="bg-black">
        <h1 className="text-white text-4xl ml-4 mb-12 py-4 md:ml-16 px-16">Key Features</h1>

        {/* Cards */}
        <div className="grid grid-cols-1 ml-2 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap- md:ml-16 lg:ml-28 mt-10 mr-16 md:mr-16 -my-6 ">
          {/* 1st card */}
